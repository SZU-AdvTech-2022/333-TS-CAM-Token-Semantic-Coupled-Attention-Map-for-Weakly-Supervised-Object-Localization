# -----------------------------------------------------------------------------------------------------
# Conformer is implemented based on https://github.com/pengzhiliang/Conformer
# -----------------------------------------------------------------------------------------------------
import torch
...
class Conformer(nn.Module):
    ...
    def forward(self, x, return_cam=False):
        ...
        if self.training:
            ...
            feature_map = torch.matmul(attn_maps.unsqueeze(1), feature_map.reshape(n, 200, h*w, 1)).reshape(n,200,h,w)
...
@register_model
def conformer_tscam_small_patch16_224(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        # )['model']
        checkpoint = torch.load('pretrained_weight/conformer_small_patch16.pth', map_location='cpu')
